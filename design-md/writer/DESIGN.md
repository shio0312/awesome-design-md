...
> **North Star**: editorial AI atelier — a white marble newsroom where pill-shaped controls and a single violet accent turn enterprise software into confident editorial design
> **Theme**: light
...
- **Orchid Accent**: `#a95ef8` — Highlighted word in display headlines, decorative emphasis — vivid violet that draws the eye to a single concept within a monochrome headline [brand]
- **Iris Brand**: `#5551ff` — Violet supporting accent for decorative details and low-frequency emphasis. Do not promote it to the primary CTA color [brand]
- **Lavender Wash**: `#e4e9ff` — Light supporting surface for subtle backgrounds and section separation. Do not promote it to the primary CTA color [accent]
- **Cobalt Spark**: `#007aff` — Blue supporting accent for decorative details and low-frequency emphasis. Do not promote it to the primary CTA color [accent]
- **Ink Black**: `#000000` — Primary body text, heading text, strong borders, and iconography [neutral]
- **Pure White**: `#ffffff` — Page canvas, card surfaces, button text on dark fills, input backgrounds [neutral]
- **Obsidian**: `#27272b` — Supporting neutral for secondary UI, dividers, and muted labels. Do not promote it to the primary CTA color [neutral]
- **Graphite**: `#2d2d2d` — Dark surface level, input borders on dark mode, secondary dark fills [neutral]
- **Mist**: `#e4e7ed` — Hairline borders, dividers, subtle card edges — the lightest structural neutral [neutral]
- **Fog**: `#d2d4d7` — Muted text, secondary borders, disabled states — mid-gray for de-emphasis [neutral]
- **Ash**: `#bdbdbd` — Placeholder text, low-priority labels, trust-logo grayscale [neutral]
- **Slate**: `#666666` — Helper text, input placeholder, secondary metadata [neutral]
- **Privacy Banner Gradient**: `#f7c8ed` — Gradient wash for announcement bar — soft pink fading to lavender white [accent]
...
- **Border Radius**: {'cards': '12px', 'icons': '12px', 'inputs': '72px', 'buttons': '60px'}
...
- {'why': 'Same pill-shaped button language (high border-radius), monochrome-with-single-accent palette, and confidence in large display type with tight tracking', 'business': 'Linear'}
- {'why': 'Similar editorial-meets-tech feel with serif body accents, generous whitespace, and a single warm accent color punctuating a near-white canvas', 'business': 'Anthropic'}
- {'why': 'Same lightweight card aesthetic, minimal elevation, grayscale trust logos, and the alternation between light editorial sections and product-heavy content blocks', 'business': 'Notion'}
- {'why': 'Same dark-section-alternating rhythm, geometric sans-serif at scale, and pill-shaped controls with minimal chrome', 'business': 'Vercel'}
