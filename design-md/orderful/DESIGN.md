# Orderful — Design System

> **North Star**: industrial command deck — a logistics dispatcher's printed control sheet in black ink and surgical vermillion, every page restrained enough to let a single CTA shout.
> **Theme**: light
> **Source**: https://www.orderful.com
> **Refero Style**: https://styles.refero.design/style/d95a35c2-d3f7-49e7-9ba7-282d52d3211d
> **Synced**: 2026-09-01
...
- **Vermillion Signal**: `#e42b0c` — Orange action color for filled buttons, selected navigation states, and focused conversion moments. [brand]
- **Ink Black**: `#000000` — Hairline borders, logo marks, high-contrast icon strokes, strong body emphasis [neutral]
- **Carbon**: `#1f1f1f` — Dark card backgrounds, inverted feature panels, footer surface [neutral]
- **Slate 900**: `#101828` — Display and heading text, hero headlines — the dominant typographic color [neutral]
- **Slate 700**: `#364153` — Navigation text, active nav items, secondary headings [neutral]
- **Slate 600**: `#4a5565` — Body copy, sub-text, icon strokes, eyebrow labels [neutral]
- **Steel**: `#676767` — Subdued heading text, testimonial attributions [neutral]
- **Iron**: `#8a8a8a` — Tertiary helper text, decorative dividers [neutral]
- **Mist**: `#99a1af` — Icon borders, muted labels, disabled states [neutral]
- **Cloud**: `#d4d4d4` — Button borders, input borders, section dividers [neutral]
- **Frost**: `#e5e7eb` — Card hairline borders, subtle container edges [neutral]
- **Paper**: `#ffffff` — Card surfaces, button text on dark fills, primary content canvas [neutral]
- **Vellum**: `#f5f5f5` — Primary page canvas and white card surfaces. [neutral]
...
- **Element Gap**: 16px
- **Section Gap**: 64px
- **Border Radius**: {'nav': '8px', 'tags': '8px', 'cards': '8px', 'images': '8px', 'inputs': '8px', 'buttons': '8px'}
...
- {'why': 'Same monochrome enterprise surface with a single vivid accent and custom geometric grotesk at large display sizes with tight negative tracking', 'business': 'Linear'}
- {'why': 'Identical ultra-clean light canvas, 8px universal radius, and discipline around a single chromatic action color used sparingly', 'business': 'Vercel'}
- {'why': 'Similar B2B SaaS restraint: black-and-white typography, flat 8px-radius cards, vermillion/orange CTA, and dense information architecture', 'business': 'Retool'}
- {'why': 'Same financial/operational feel — calm matte paper canvas, sober typographic hierarchy, and one surgical accent for action surfaces', 'business': 'Mercury'}
- {'why': 'Matching enterprise-B2B voice with a near-pure achromatic palette, generous section spacing, and a single bold accent for primary actions', 'business': 'Ramp'}
